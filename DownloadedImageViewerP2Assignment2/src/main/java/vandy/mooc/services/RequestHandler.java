...
class RequestHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        // TODO -- you fill in here.
        final Uri imageUri = requestMessage.getImageURL();
        ...
        final Runnable downloadImageAndReply = 
            new Runnable() {
                ...
                public void run() {
                    ...
                    // TODO -- you fill in here.
                    final Uri pathToImageFile = Utils.downloadImage(mService.get(), imageUri, directoryPathname);

                    // Send the path to the image file, url, and
                    // requestCode back to the Activity via the
                    // replyMessenger.
                    // TODO -- you fill in here.
                    sendPath(replyMessenger, pathToImageFile, imageUri, requestCode);
                }
            };
